...
@section('head.title','Danh Sách Dự Án')
                ...
                <div class="animated fadeIn">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-edit"></i> Danh Sách Dự Án
                            <div class="card-header-actions">
                                <a class="btn btn-block btn-outline-primary active" href="{{route('admin.project.create')}}">
                                    Tạo mới
                                </a>
                            </div>
                        </div>
                                            ...
                                            @foreach($products as $key => $product)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-info" href="{{route('admin.project.update',['id' => $product->id])}}">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a data-toggle="modal" class="btn btn-danger anchorClick"
                                                           data-url="{{route('admin.project.delete',['id' => $product->id]) }}"
